...
UPDATE public.intake_document_system_templates SET
  ...
  html_content = '<div class="document-header"><h1>Einwilligung zur Verarbeitung personenbezogener Daten</h1><p class="subtitle">gemäß Art. 6 Abs. 1 lit. a, Art. 7 und Art. 9 Abs. 2 lit. a DSGVO</p></div>
...
<p class="document-meta">Aufnahmedatum: {{intake.date}} · Aufnahmeort: {{intake.location}} · Leistungsart: {{service.type}}</p>
...
<div class="document-signature-block"><p class="document-paragraph"><strong>Ort, Datum:</strong> {{document.location}}, {{document.date}}</p><div class="sig-row"><div class="sig-field"><div class="sig-line">{{signature.client}}</div><div class="sig-label">Klient:in / zu betreuende Person</div></div></div></div>
<p class="document-footer-note">Systemvorlage — vom Mandanten prüfbar. Keine automatische Rechtsberatung.</p>',
  plain_text_content = 'Umfassende Einwilligung zur Verarbeitung personenbezogener Daten gemäß DSGVO inkl. Gesundheitsdaten.',
  placeholder_schema = '{"tenant.name":{"label":"Mandantenname","required":true},"tenant.street":{"label":"Mandantenstraße","required":false},"tenant.zip":{"label":"Mandanten-PLZ","required":false},"tenant.city":{"label":"Mandantenort","required":false},"client.full_name":{"label":"Name Klient:in","required":true},"client.date_of_birth":{"label":"Geburtsdatum","required":true},"client.street":{"label":"Klientenadresse","required":false},"client.zip":{"label":"Klienten-PLZ","required":false},"client.city":{"label":"Klientenort","required":false},"document.date":{"label":"Datum","required":true},"document.location":{"label":"Ort","required":true},"intake.date":{"label":"Aufnahmedatum","required":false},"intake.location":{"label":"Aufnahmeort","required":false},"service.type":{"label":"Leistungsart","required":false},"care.level":{"label":"Pflegegrad","required":false},"cost_carrier.care_fund_name":{"label":"Pflegekasse","required":false},"cost_carrier.care_fund_ik":{"label":"Pflegekassen-IK","required":false},"cost_carrier.health_insurance_name":{"label":"Krankenkasse","required":false}}'::jsonb,
  signature_slots = '[{"role":"client","placeholder":"{{signature.client}}","required":true}]'::jsonb,
  updated_at = NOW()
...
<div class="document-signature-block"><p class="document-paragraph"><strong>Ort, Datum:</strong> {{document.location}}, {{document.date}}</p><div class="sig-row"><div class="sig-field"><div class="sig-line">{{signature.client}}</div><div class="sig-label">Klient:in / zu betreuende Person</div></div></div></div>',
  plain_text_content = 'Abtretungserklärung und Zahlungsauftrag zur Direktabrechnung mit der Pflegekasse.',
  placeholder_schema = '{"tenant.name":{"label":"Mandantenname","required":true},"tenant.street":{"label":"Mandantenstraße","required":false},"tenant.zip":{"label":"Mandanten-PLZ","required":false},"tenant.city":{"label":"Mandantenort","required":false},"client.full_name":{"label":"Name Klient:in","required":true},"client.date_of_birth":{"label":"Geburtsdatum","required":true},"client.street":{"label":"Klientenadresse","required":false},"client.zip":{"label":"Klienten-PLZ","required":false},"client.city":{"label":"Klientenort","required":false},"document.date":{"label":"Datum","required":true},"document.location":{"label":"Ort","required":true},"intake.date":{"label":"Aufnahmedatum","required":false},"intake.location":{"label":"Aufnahmeort","required":false},"service.type":{"label":"Leistungsart","required":false},"care.level":{"label":"Pflegegrad","required":true},"cost_carrier.care_fund_name":{"label":"Pflegekasse","required":true},"cost_carrier.care_fund_ik":{"label":"Pflegekassen-IK","required":false},"client.insurance_number":{"label":"Versichertennummer","required":true},"contract.service_start":{"label":"Leistungsbeginn","required":true},"billing.types":{"label":"Abrechnungsart","required":false},"billing.hourly_rate":{"label":"Stundensatz","required":false}}'::jsonb,
  signature_slots = '[{"role":"client","placeholder":"{{signature.client}}","required":true}]'::jsonb,
  updated_at = NOW()
WHERE template_key = 'assignment_declaration_care_health_insurance';
...
UPDATE public.intake_document_system_templates SET
  ...
  requires_representative_signature = false,
  html_content = '<div class="document-header"><h1>Versorgungsvertrag — Alltagsbegleitung und Betreuung</h1><p class="subtitle">Individuelle Unterstützung im Alltag</p></div>
<div class="document-parties"><table>
<tr><td class="label">Leistungserbringer:</td><td><strong>{{tenant.name}}</strong><br/>{{tenant.street}}<br/>{{tenant.zip}} {{tenant.city}}</td></tr>
<tr><td class="label">Klient:in:</td><td><strong>{{client.salutation}} {{client.full_name}}</strong><br/>geb. am {{client.date_of_birth}}<br/>{{client.street}}<br/>{{client.zip}} {{client.city}}</td></tr>
<tr><td class="label">Pflegegrad:</td><td>{{care.level}}</td></tr>
...
<div class="document-signature-block"><p class="document-paragraph"><strong>Ort, Datum:</strong> {{document.location}}, {{document.date}}</p><div class="sig-row"><div class="sig-field"><div class="sig-line">{{signature.client}}</div><div class="sig-label">Klient:in / zu betreuende Person</div></div><div class="sig-field"><div class="sig-line">{{signature.employee}}</div><div class="sig-label">Mitarbeitende:r (Leistungserbringer)</div></div></div></div>',
  plain_text_content = 'Versorgungsvertrag Alltagsbegleitung und Betreuung mit Leistungsumfang, Abrechnung und Kündigung.',
  placeholder_schema = '{"tenant.name":{"label":"Mandantenname","required":true},"tenant.street":{"label":"Mandantenstraße","required":false},"tenant.zip":{"label":"Mandanten-PLZ","required":false},"tenant.city":{"label":"Mandantenort","required":false},"client.full_name":{"label":"Name Klient:in","required":true},"client.date_of_birth":{"label":"Geburtsdatum","required":true},"client.street":{"label":"Klientenadresse","required":false},"client.zip":{"label":"Klienten-PLZ","required":false},"client.city":{"label":"Klientenort","required":false},"document.date":{"label":"Datum","required":true},"document.location":{"label":"Ort","required":true},"intake.date":{"label":"Aufnahmedatum","required":false},"intake.location":{"label":"Aufnahmeort","required":false},"service.type":{"label":"Leistungsart","required":false},"care.level":{"label":"Pflegegrad","required":false},"contract.service_start":{"label":"Leistungsbeginn","required":true},"billing.types":{"label":"Abrechnungsart","required":false},"billing.hourly_rate":{"label":"Stundensatz","required":false},"cost_carrier.primary_name":{"label":"Kostenträger","required":false},"emergency.name":{"label":"Notfallkontakt","required":false},"emergency.phone":{"label":"Notfall-Telefon","required":false}}'::jsonb,
  signature_slots = '[{"role":"client","placeholder":"{{signature.client}}","required":true},{"role":"employee","placeholder":"{{signature.employee}}","required":true}]'::jsonb,
  updated_at = NOW()
WHERE template_key = 'client_contract_assist';
...
UPDATE public.intake_document_system_templates SET
  ...
  requires_employee_signature = true,
  requires_representative_signature = false,
  html_content = '<div class="document-header"><h1>Versorgungsvertrag — Ambulante Pflege</h1><p class="subtitle">gemäß SGB XI</p></div>
<div class="document-parties"><table>
<tr><td class="label">Leistungserbringer:</td><td><strong>{{tenant.name}}</strong><br/>{{tenant.street}}<br/>{{tenant.zip}} {{tenant.city}}</td></tr>
<tr><td class="label">Klient:in:</td><td><strong>{{client.salutation}} {{client.full_name}}</strong><br/>geb. am {{client.date_of_birth}}<br/>{{client.street}}<br/>{{client.zip}} {{client.city}}</td></tr>
<tr><td class="label">Pflegegrad:</td><td>{{care.level}}</td></tr>
...
<div class="document-signature-block"><p class="document-paragraph"><strong>Ort, Datum:</strong> {{document.location}}, {{document.date}}</p><div class="sig-row"><div class="sig-field"><div class="sig-line">{{signature.client}}</div><div class="sig-label">Klient:in / zu betreuende Person</div></div><div class="sig-field"><div class="sig-line">{{signature.employee}}</div><div class="sig-label">Mitarbeitende:r (Leistungserbringer)</div></div></div></div>',
  plain_text_content = 'Versorgungsvertrag ambulante Pflege gemäß SGB XI mit Pflegegrad, Dokumentation und Abrechnung.',
  placeholder_schema = '{"tenant.name":{"label":"Mandantenname","required":true},"tenant.street":{"label":"Mandantenstraße","required":false},"tenant.zip":{"label":"Mandanten-PLZ","required":false},"tenant.city":{"label":"Mandantenort","required":false},"client.full_name":{"label":"Name Klient:in","required":true},"client.date_of_birth":{"label":"Geburtsdatum","required":true},"client.street":{"label":"Klientenadresse","required":false},"client.zip":{"label":"Klienten-PLZ","required":false},"client.city":{"label":"Klientenort","required":false},"document.date":{"label":"Datum","required":true},"document.location":{"label":"Ort","required":true},"intake.date":{"label":"Aufnahmedatum","required":false},"intake.location":{"label":"Aufnahmeort","required":false},"service.type":{"label":"Leistungsart","required":false},"care.level":{"label":"Pflegegrad","required":true},"cost_carrier.care_fund_name":{"label":"Pflegekasse","required":true},"contract.service_start":{"label":"Leistungsbeginn","required":true},"billing.types":{"label":"Abrechnungsart","required":false},"emergency.name":{"label":"Notfallkontakt","required":false},"emergency.phone":{"label":"Notfall-Telefon","required":false}}'::jsonb,
  signature_slots = '[{"role":"client","placeholder":"{{signature.client}}","required":true},{"role":"employee","placeholder":"{{signature.employee}}","required":true}]'::jsonb,
  updated_at = NOW()
WHERE template_key = 'client_contract_ambulatory_care';
...
UPDATE public.intake_document_system_templates SET
  ...
  requires_employee_signature = true,
  requires_representative_signature = false,
  html_content = '<div class="document-header"><h1>Versorgungsvertrag — Stationäre Pflege / Vollstationäre Versorgung</h1><p class="subtitle">gemäß HeimG und SGB XI</p></div>
<div class="document-parties"><table>
<tr><td class="label">Leistungserbringer:</td><td><strong>{{tenant.name}}</strong><br/>{{tenant.street}}<br/>{{tenant.zip}} {{tenant.city}}</td></tr>
<tr><td class="label">Klient:in:</td><td><strong>{{client.salutation}} {{client.full_name}}</strong><br/>geb. am {{client.date_of_birth}}<br/>{{client.street}}<br/>{{client.zip}} {{client.city}}</td></tr>
<tr><td class="label">Pflegegrad:</td><td>{{care.level}}</td></tr>
...
<div class="document-signature-block"><p class="document-paragraph"><strong>Ort, Datum:</strong> {{document.location}}, {{document.date}}</p><div class="sig-row"><div class="sig-field"><div class="sig-line">{{signature.client}}</div><div class="sig-label">Klient:in / zu betreuende Person</div></div><div class="sig-field"><div class="sig-line">{{signature.employee}}</div><div class="sig-label">Mitarbeitende:r (Leistungserbringer)</div></div></div></div>',
  plain_text_content = 'Versorgungsvertrag stationäre Pflege mit Unterbringung, Leistungsumfang und Abrechnung.',
  placeholder_schema = '{"tenant.name":{"label":"Mandantenname","required":true},"tenant.street":{"label":"Mandantenstraße","required":false},"tenant.zip":{"label":"Mandanten-PLZ","required":false},"tenant.city":{"label":"Mandantenort","required":false},"client.full_name":{"label":"Name Klient:in","required":true},"client.date_of_birth":{"label":"Geburtsdatum","required":true},"client.street":{"label":"Klientenadresse","required":false},"client.zip":{"label":"Klienten-PLZ","required":false},"client.city":{"label":"Klientenort","required":false},"document.date":{"label":"Datum","required":true},"document.location":{"label":"Ort","required":true},"intake.date":{"label":"Aufnahmedatum","required":false},"intake.location":{"label":"Aufnahmeort","required":false},"service.type":{"label":"Leistungsart","required":false},"care.level":{"label":"Pflegegrad","required":true},"facility.name":{"label":"Einrichtung","required":true},"facility.care_area":{"label":"Wohnbereich","required":false},"facility.room_number":{"label":"Zimmernummer","required":false},"contract.service_start":{"label":"Einzugsdatum","required":true},"cost_carrier.care_fund_name":{"label":"Pflegekasse","required":false},"billing.types":{"label":"Abrechnungsart","required":false},"emergency.name":{"label":"Notfallkontakt","required":false},"emergency.phone":{"label":"Notfall-Telefon","required":false}}'::jsonb,
  signature_slots = '[{"role":"client","placeholder":"{{signature.client}}","required":true},{"role":"employee","placeholder":"{{signature.employee}}","required":true}]'::jsonb,
  updated_at = NOW()
WHERE template_key = 'client_contract_stationary_care';
...
UPDATE public.intake_document_system_templates SET
  ...
  requires_employee_signature = true,
  requires_representative_signature = false,
  html_content = '<div class="document-header"><h1>Beratungsvereinbarung — Pflegeberatung nach § 7a SGB XI</h1><p class="subtitle">Individuelle Beratung und Versorgungsplanung</p></div>
<div class="document-parties"><table>
<tr><td class="label">Leistungserbringer:</td><td><strong>{{tenant.name}}</strong><br/>{{tenant.street}}<br/>{{tenant.zip}} {{tenant.city}}</td></tr>
<tr><td class="label">Klient:in:</td><td><strong>{{client.salutation}} {{client.full_name}}</strong><br/>geb. am {{client.date_of_birth}}<br/>{{client.street}}<br/>{{client.zip}} {{client.city}}</td></tr>
<tr><td class="label">Pflegegrad:</td><td>{{care.level}}</td></tr>
...
<div class="document-signature-block"><p class="document-paragraph"><strong>Ort, Datum:</strong> {{document.location}}, {{document.date}}</p><div class="sig-row"><div class="sig-field"><div class="sig-line">{{signature.client}}</div><div class="sig-label">Klient:in / zu betreuende Person</div></div><div class="sig-field"><div class="sig-line">{{signature.employee}}</div><div class="sig-label">Mitarbeitende:r (Leistungserbringer)</div></div></div></div>',
  plain_text_content = 'Beratungsvereinbarung Pflegeberatung nach § 7a SGB XI.',
  placeholder_schema = '{"tenant.name":{"label":"Mandantenname","required":true},"tenant.street":{"label":"Mandantenstraße","required":false},"tenant.zip":{"label":"Mandanten-PLZ","required":false},"tenant.city":{"label":"Mandantenort","required":false},"client.full_name":{"label":"Name Klient:in","required":true},"client.date_of_birth":{"label":"Geburtsdatum","required":true},"client.street":{"label":"Klientenadresse","required":false},"client.zip":{"label":"Klienten-PLZ","required":false},"client.city":{"label":"Klientenort","required":false},"document.date":{"label":"Datum","required":true},"document.location":{"label":"Ort","required":true},"intake.date":{"label":"Aufnahmedatum","required":false},"intake.location":{"label":"Aufnahmeort","required":false},"service.type":{"label":"Leistungsart","required":false},"care.level":{"label":"Pflegegrad","required":false},"consulting.reason":{"label":"Beratungsanlass","required":true},"consulting.type":{"label":"Beratungsart","required":false},"contract.service_start":{"label":"Beratungsbeginn","required":true},"cost_carrier.care_fund_name":{"label":"Pflegekasse","required":false},"billing.types":{"label":"Abrechnungsart","required":false}}'::jsonb,
  signature_slots = '[{"role":"client","placeholder":"{{signature.client}}","required":true},{"role":"employee","placeholder":"{{signature.employee}}","required":true}]'::jsonb,
  updated_at = NOW()
WHERE template_key = 'client_contract_care_consulting';
...
UPDATE public.intake_document_system_templates SET
  ...
  requires_employee_signature = true,
  requires_representative_signature = false,
  html_content = '<div class="document-header"><h1>Versorgungsvertrag — Tagespflege</h1><p class="subtitle">gemäß § 41 SGB XI</p></div>
<div class="document-parties"><table>
<tr><td class="label">Leistungserbringer:</td><td><strong>{{tenant.name}}</strong><br/>{{tenant.street}}<br/>{{tenant.zip}} {{tenant.city}}</td></tr>
<tr><td class="label">Klient:in:</td><td><strong>{{client.salutation}} {{client.full_name}}</strong><br/>geb. am {{client.date_of_birth}}<br/>{{client.street}}<br/>{{client.zip}} {{client.city}}</td></tr>
<tr><td class="label">Pflegegrad:</td><td>{{care.level}}</td></tr>
...
<div class="document-signature-block"><p class="document-paragraph"><strong>Ort, Datum:</strong> {{document.location}}, {{document.date}}</p><div class="sig-row"><div class="sig-field"><div class="sig-line">{{signature.client}}</div><div class="sig-label">Klient:in / zu betreuende Person</div></div><div class="sig-field"><div class="sig-line">{{signature.employee}}</div><div class="sig-label">Mitarbeitende:r (Leistungserbringer)</div></div></div></div>',
  plain_text_content = 'Versorgungsvertrag Tagespflege gemäß § 41 SGB XI.',
  placeholder_schema = '{"tenant.name":{"label":"Mandantenname","required":true},"tenant.street":{"label":"Mandantenstraße","required":false},"tenant.zip":{"label":"Mandanten-PLZ","required":false},"tenant.city":{"label":"Mandantenort","required":false},"client.full_name":{"label":"Name Klient:in","required":true},"client.date_of_birth":{"label":"Geburtsdatum","required":true},"client.street":{"label":"Klientenadresse","required":false},"client.zip":{"label":"Klienten-PLZ","required":false},"client.city":{"label":"Klientenort","required":false},"document.date":{"label":"Datum","required":true},"document.location":{"label":"Ort","required":true},"intake.date":{"label":"Aufnahmedatum","required":false},"intake.location":{"label":"Aufnahmeort","required":false},"service.type":{"label":"Leistungsart","required":false},"care.level":{"label":"Pflegegrad","required":true},"contract.service_start":{"label":"Leistungsbeginn","required":true},"billing.types":{"label":"Abrechnungsart","required":false},"cost_carrier.care_fund_name":{"label":"Pflegekasse","required":false},"emergency.name":{"label":"Notfallkontakt","required":false},"emergency.phone":{"label":"Notfall-Telefon","required":false}}'::jsonb,
  signature_slots = '[{"role":"client","placeholder":"{{signature.client}}","required":true},{"role":"employee","placeholder":"{{signature.employee}}","required":true}]'::jsonb,
  updated_at = NOW()
WHERE template_key = 'client_contract_day_care';
...
UPDATE public.intake_document_system_templates SET
  ...
  requires_employee_signature = true,
  requires_representative_signature = false,
  html_content = '<div class="document-header"><h1>Versorgungsvertrag — Entlastungsleistungen</h1><p class="subtitle">gemäß § 45b SGB XI</p></div>
<div class="document-parties"><table>
<tr><td class="label">Leistungserbringer:</td><td><strong>{{tenant.name}}</strong><br/>{{tenant.street}}<br/>{{tenant.zip}} {{tenant.city}}</td></tr>
<tr><td class="label">Klient:in:</td><td><strong>{{client.salutation}} {{client.full_name}}</strong><br/>geb. am {{client.date_of_birth}}<br/>{{client.street}}<br/>{{client.zip}} {{client.city}}</td></tr>
<tr><td class="label">Pflegegrad:</td><td>{{care.level}}</td></tr>
...
<p class="document-paragraph">Schriftform für Änderungen. Deutsches Recht.</p></div>
<div class="document-signature-block"><p class="document-paragraph"><strong>Ort, Datum:</strong> {{document.location}}, {{document.date}}</p><div class="sig-row"><div class="sig-field"><div class="sig-line">{{signature.client}}</div><div class="sig-label">Klient:in / zu betreuende Person</div></div><div class="sig-field"><div class="sig-line">{{signature.employee}}</div><div class="sig-label">Mitarbeitende:r (Leistungserbringer)</div></div></div></div>',
  plain_text_content = 'Versorgungsvertrag Entlastungsleistungen gemäß § 45b SGB XI.',
  placeholder_schema = '{"tenant.name":{"label":"Mandantenname","required":true},"tenant.street":{"label":"Mandantenstraße","required":false},"tenant.zip":{"label":"Mandanten-PLZ","required":false},"tenant.city":{"label":"Mandantenort","required":false},"client.full_name":{"label":"Name Klient:in","required":true},"client.date_of_birth":{"label":"Geburtsdatum","required":true},"client.street":{"label":"Klientenadresse","required":false},"client.zip":{"label":"Klienten-PLZ","required":false},"client.city":{"label":"Klientenort","required":false},"document.date":{"label":"Datum","required":true},"document.location":{"label":"Ort","required":true},"intake.date":{"label":"Aufnahmedatum","required":false},"intake.location":{"label":"Aufnahmeort","required":false},"service.type":{"label":"Leistungsart","required":false},"care.level":{"label":"Pflegegrad","required":true},"contract.service_start":{"label":"Leistungsbeginn","required":true},"billing.types":{"label":"Abrechnungsart","required":false},"cost_carrier.care_fund_name":{"label":"Pflegekasse","required":false}}'::jsonb,
  signature_slots = '[{"role":"client","placeholder":"{{signature.client}}","required":true},{"role":"employee","placeholder":"{{signature.employee}}","required":true}]'::jsonb,
  updated_at = NOW()
WHERE template_key = 'client_contract_relief_services';
...
UPDATE public.intake_document_system_templates SET
  ...
  requires_employee_signature = false,
  requires_representative_signature = false,
  html_content = '<div class="document-header"><h1>Schweigepflichtentbindungserklärung</h1><p class="subtitle">Entbindung von der ärztlichen Schweigepflicht — § 203 StGB</p></div>
<div class="document-parties"><table>
<tr><td class="label">Leistungserbringer:</td><td><strong>{{tenant.name}}</strong><br/>{{tenant.street}}<br/>{{tenant.zip}} {{tenant.city}}</td></tr>
<tr><td class="label">Klient:in:</td><td><strong>{{client.salutation}} {{client.full_name}}</strong><br/>geb. am {{client.date_of_birth}}<br/>{{client.street}}<br/>{{client.zip}} {{client.city}}</td></tr>
<tr><td class="label">Pflegegrad:</td><td>{{care.level}}</td></tr>
...
<div class="document-signature-block"><p class="document-paragraph"><strong>Ort, Datum:</strong> {{document.location}}, {{document.date}}</p><div class="sig-row"><div class="sig-field"><div class="sig-line">{{signature.client}}</div><div class="sig-label">Klient:in / zu betreuende Person</div></div></div></div>',
  plain_text_content = 'Schweigepflichtentbindung gegenüber dem Leistungserbringer im Kontext von § 203 StGB.',
  placeholder_schema = '{"tenant.name":{"label":"Mandantenname","required":true},"tenant.street":{"label":"Mandantenstraße","required":false},"tenant.zip":{"label":"Mandanten-PLZ","required":false},"tenant.city":{"label":"Mandantenort","required":false},"client.full_name":{"label":"Name Klient:in","required":true},"client.date_of_birth":{"label":"Geburtsdatum","required":true},"client.street":{"label":"Klientenadresse","required":false},"client.zip":{"label":"Klienten-PLZ","required":false},"client.city":{"label":"Klientenort","required":false},"document.date":{"label":"Datum","required":true},"document.location":{"label":"Ort","required":true},"intake.date":{"label":"Aufnahmedatum","required":false},"intake.location":{"label":"Aufnahmeort","required":false},"service.type":{"label":"Leistungsart","required":false},"care.level":{"label":"Pflegegrad","required":false},"consulting.family_doctor":{"label":"Hausarzt/Hausärztin","required":false}}'::jsonb,
  signature_slots = '[{"role":"client","placeholder":"{{signature.client}}","required":true}]'::jsonb,
  updated_at = NOW()
...
UPDATE public.intake_document_system_templates SET
  ...
  requires_employee_signature = false,
  requires_representative_signature = false,
  html_content = '<div class="document-header"><h1>Einwilligung zur elektronischen Kommunikation</h1><p class="subtitle">E-Mail, SMS, Telefon und Messenger-Dienste</p></div>
<div class="document-parties"><table>
<tr><td class="label">Leistungserbringer:</td><td><strong>{{tenant.name}}</strong><br/>{{tenant.street}}<br/>{{tenant.zip}} {{tenant.city}}</td></tr>
<tr><td class="label">Klient:in:</td><td><strong>{{client.salutation}} {{client.full_name}}</strong><br/>geb. am {{client.date_of_birth}}<br/>{{client.street}}<br/>{{client.zip}} {{client.city}}</td></tr>
<tr><td class="label">Pflegegrad:</td><td>{{care.level}}</td></tr>
...
<div class="document-signature-block"><p class="document-paragraph"><strong>Ort, Datum:</strong> {{document.location}}, {{document.date}}</p><div class="sig-row"><div class="sig-field"><div class="sig-line">{{signature.client}}</div><div class="sig-label">Klient:in / zu betreuende Person</div></div></div></div>',
  plain_text_content = 'Einwilligung zur Kommunikation per E-Mail, SMS, Telefon und Portal.',
  placeholder_schema = '{"tenant.name":{"label":"Mandantenname","required":true},"tenant.street":{"label":"Mandantenstraße","required":false},"tenant.zip":{"label":"Mandanten-PLZ","required":false},"tenant.city":{"label":"Mandantenort","required":false},"client.full_name":{"label":"Name Klient:in","required":true},"client.date_of_birth":{"label":"Geburtsdatum","required":true},"client.street":{"label":"Klientenadresse","required":false},"client.zip":{"label":"Klienten-PLZ","required":false},"client.city":{"label":"Klientenort","required":false},"document.date":{"label":"Datum","required":true},"document.location":{"label":"Ort","required":true},"intake.date":{"label":"Aufnahmedatum","required":false},"intake.location":{"label":"Aufnahmeort","required":false},"service.type":{"label":"Leistungsart","required":false},"care.level":{"label":"Pflegegrad","required":false},"client.phone":{"label":"Telefon","required":false},"client.email":{"label":"E-Mail","required":false}}'::jsonb,
  signature_slots = '[{"role":"client","placeholder":"{{signature.client}}","required":true}]'::jsonb,
  updated_at = NOW()
WHERE template_key = 'communication_consent_default';
...
UPDATE public.intake_document_system_templates SET
  ...
  requires_employee_signature = false,
  requires_representative_signature = false,
  html_content = '<div class="document-header"><h1>Einwilligung zur Foto- und Medienerfassung</h1><p class="subtitle">Dokumentationszweck im geschützten System</p></div>
<div class="document-parties"><table>
<tr><td class="label">Leistungserbringer:</td><td><strong>{{tenant.name}}</strong><br/>{{tenant.street}}<br/>{{tenant.zip}} {{tenant.city}}</td></tr>
<tr><td class="label">Klient:in:</td><td><strong>{{client.salutation}} {{client.full_name}}</strong><br/>geb. am {{client.date_of_birth}}<br/>{{client.street}}<br/>{{client.zip}} {{client.city}}</td></tr>
<tr><td class="label">Pflegegrad:</td><td>{{care.level}}</td></tr>
...
<div class="document-signature-block"><p class="document-paragraph"><strong>Ort, Datum:</strong> {{document.location}}, {{document.date}}</p><div class="sig-row"><div class="sig-field"><div class="sig-line">{{signature.client}}</div><div class="sig-label">Klient:in / zu betreuende Person</div></div></div></div>',
  plain_text_content = 'Einwilligung zur Foto- und Medienerfassung zu Dokumentationszwecken.',
  placeholder_schema = '{"tenant.name":{"label":"Mandantenname","required":true},"tenant.street":{"label":"Mandantenstraße","required":false},"tenant.zip":{"label":"Mandanten-PLZ","required":false},"tenant.city":{"label":"Mandantenort","required":false},"client.full_name":{"label":"Name Klient:in","required":true},"client.date_of_birth":{"label":"Geburtsdatum","required":true},"client.street":{"label":"Klientenadresse","required":false},"client.zip":{"label":"Klienten-PLZ","required":false},"client.city":{"label":"Klientenort","required":false},"document.date":{"label":"Datum","required":true},"document.location":{"label":"Ort","required":true},"intake.date":{"label":"Aufnahmedatum","required":false},"intake.location":{"label":"Aufnahmeort","required":false},"service.type":{"label":"Leistungsart","required":false},"care.level":{"label":"Pflegegrad","required":false}}'::jsonb,
  signature_slots = '[{"role":"client","placeholder":"{{signature.client}}","required":true}]'::jsonb,
  updated_at = NOW()
WHERE template_key = 'photo_media_consent_default';
...
UPDATE public.intake_document_system_templates SET
  ...
  requires_employee_signature = false,
  requires_representative_signature = false,
  html_content = '<div class="document-header"><h1>Einwilligung zur Kontaktaufnahme im Notfall</h1><p class="subtitle">Benannte Notfallkontaktperson</p></div>
<div class="document-parties"><table>
<tr><td class="label">Leistungserbringer:</td><td><strong>{{tenant.name}}</strong><br/>{{tenant.street}}<br/>{{tenant.zip}} {{tenant.city}}</td></tr>
<tr><td class="label">Klient:in:</td><td><strong>{{client.salutation}} {{client.full_name}}</strong><br/>geb. am {{client.date_of_birth}}<br/>{{client.street}}<br/>{{client.zip}} {{client.city}}</td></tr>
<tr><td class="label">Pflegegrad:</td><td>{{care.level}}</td></tr>
...
<div class="document-signature-block"><p class="document-paragraph"><strong>Ort, Datum:</strong> {{document.location}}, {{document.date}}</p><div class="sig-row"><div class="sig-field"><div class="sig-line">{{signature.client}}</div><div class="sig-label">Klient:in / zu betreuende Person</div></div></div></div>',
  plain_text_content = 'Einwilligung zur Kontaktaufnahme mit der Notfallkontaktperson.',
  placeholder_schema = '{"tenant.name":{"label":"Mandantenname","required":true},"tenant.street":{"label":"Mandantenstraße","required":false},"tenant.zip":{"label":"Mandanten-PLZ","required":false},"tenant.city":{"label":"Mandantenort","required":false},"client.full_name":{"label":"Name Klient:in","required":true},"client.date_of_birth":{"label":"Geburtsdatum","required":true},"client.street":{"label":"Klientenadresse","required":false},"client.zip":{"label":"Klienten-PLZ","required":false},"client.city":{"label":"Klientenort","required":false},"document.date":{"label":"Datum","required":true},"document.location":{"label":"Ort","required":true},"intake.date":{"label":"Aufnahmedatum","required":false},"intake.location":{"label":"Aufnahmeort","required":false},"service.type":{"label":"Leistungsart","required":false},"care.level":{"label":"Pflegegrad","required":false},"emergency.name":{"label":"Notfallkontakt","required":true},"emergency.phone":{"label":"Notfall-Telefon","required":true}}'::jsonb,
  signature_slots = '[{"role":"client","placeholder":"{{signature.client}}","required":true}]'::jsonb,
  updated_at = NOW()
WHERE template_key = 'emergency_contact_consent_default';
