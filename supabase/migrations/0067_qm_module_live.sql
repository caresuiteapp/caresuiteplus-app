-- Office QM dashboard: remote missing 0015 QM tables (only legacy qm_tasks exists).
-- PostgREST GET /rest/v1/qm_handbook_chapters → 404 PGRST205 → "Datenbankfehler: Bitte erneut versuchen."
-- Pattern: 0015_quality_management_module.sql + idempotent RLS/GRANT (see 0066 appointments fix).
