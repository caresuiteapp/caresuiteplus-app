-- Assist module: remote missing assignments production columns from 0044 (never applied).
-- PostgREST GET /rest/v1/assignments?select=...,on_the_way_at,... → 400 column does not exist
-- → app shows "Datenbankfehler: Bitte erneut versuchen." on all Assist pages.
-- Pattern: 0044_assignments_production.sql
