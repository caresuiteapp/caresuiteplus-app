...
OUTPUT_PATH="${1:-CareSuite-HealthOS-0.3.3.aab}"
...
if (app.version !== '0.3.3') throw new Error('Falsche Nutzer-Version.');
if (app.android?.versionCode < 26) throw new Error('Falsche lokale versionCode-Baseline.');
...
printf '\nGoogle-Play-Update 0.3.3 wurde vollständig gebaut und heruntergeladen:\n%s\n' "$OUTPUT_PATH"
