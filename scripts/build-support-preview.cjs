...
(async()=>{
 ...
 fs.writeFileSync(path.join(target,'index.html'),'<!doctype html><html lang="de"><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>CareSuite Support – UI-Test</title><div id="qa">UI-Test mit fiktiven Daten · Support-Layout R2 · <a style="color:#86DEFF" href="?platform=0">Unternehmen</a> · <a style="color:#86DEFF" href="?platform=1">Support-Zentrale</a></div><div id="preview"></div><script src="support.js"></script></html>');
