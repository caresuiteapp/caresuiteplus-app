...
console.log('Phase-8-Diversvergleich vollständig gerendert.');
console.log(`Modelle: ${DIVERS_REFERENCE_VARIANTS.length}/8`);
console.log(`Ansichten: ${DIVERS_REFERENCE_VARIANTS.length * 4}/32`);
