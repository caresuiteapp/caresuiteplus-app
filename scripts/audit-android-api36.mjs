...
const checks = {
  ...
  releaseMinification: properties.get('android.enableMinifyInReleaseBuilds') === 'true',
  releaseResourceShrinking: properties.get('android.enableShrinkResourcesInReleaseBuilds') === 'true',
  optimizedResourceShrinking: properties.get('android.r8.optimizedResourceShrinking') === 'true',
  r8FullMode: properties.get('android.enableR8.fullMode') !== 'false',
