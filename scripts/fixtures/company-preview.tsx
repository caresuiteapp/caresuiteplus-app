...
import { AppStartIntro } from '../../src/components/brand/AppStartIntro.web';
...
import { CommandCenterScreen } from '../../src/liquid-command/screens/CommandCenterScreen.web';
...
function App() {
 ...
 if (path === '/desktop') return <CommandCenterScreen />;
...
createRoot(document.getElementById('preview')!).render(<AppStartIntro><ThemeModeProvider><WebFontScaleProvider><App /></WebFontScaleProvider></ThemeModeProvider></AppStartIntro>);
