...
(async () => {
 ...
 fs.writeFileSync(path.join(target, 'index.html'), '<!doctype html><html lang="de"><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="Content-Security-Policy" content="'+csp+'"><title>CareSuite – Web-Prüfung R3</title><div id="qa"><strong>Web-Prüfung R3 · ausschließlich fiktive Daten</strong><a href="#/auth/register">Registrierung</a><a href="#/platform/tenants">Unternehmen</a><a href="?platform=1#/platform/support">Support-Zentrale</a><br>Änderungen gelten nur in dieser Vorschau und werden beim Neuladen zurückgesetzt.</div><div id="preview"></div><script src="company.js"></script></html>');
