...
type ResidentsListHeroProps = {
  kpis: ResidentListKpi[];
  roleKey: RoleKey;
...
export function ResidentsListHero({
  kpis,
  roleKey,
  filteredCount,
  totalCount,
...
}: ResidentsListHeroProps) {
  const accent = moduleColor('stationaer');
    ...
    <CareLightListHeroFrame accentColor={accent}>
      <View style={styles.topRow}>
        <View style={styles.textCol}>
          ...
          <Text style={styles.title}>Bewohner:innen</Text>
