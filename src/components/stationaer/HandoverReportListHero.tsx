...
type HandoverReportListHeroProps = {
...
export function HandoverReportListHero({
  items,
  roleKey,
  viewMode = 'cards',
  onViewModeChange,
  ...
  const kpis = buildHandoverReportListKpis(items, mode);
    ...
    <PremiumListHeroFrame>
      <View style={styles.topRow}>
        <View style={styles.textCol}>
          ...
          <Text style={styles.title}>Übergabeberichte</Text>
          <Text style={styles.meta}>Schichtübergaben dokumentieren und nachverfolgen</Text>
        </View>
      ...
      {!isStationaerExtensionLiveReady() ? (
        <Text style={styles.preparedHint}>
          {STATIONAER_EXTENSION_PREPARED_MESSAGE} Neue Übergabe mit Live-Persistenz folgt.
        </Text>
      ) : null}
