...
type StationaerSettingsHeroProps = {
  settings: StationaerModuleSettings;
  roleKey: RoleKey;
};

export function StationaerSettingsHero({ settings, roleKey }: StationaerSettingsHeroProps) {
  ...
  const kpis = buildStationaerSettingsKpis(settings, mode);
    ...
    <PremiumListHeroFrame>
      <View style={styles.topRow}>
        <View style={styles.textCol}>
          ...
          <Text style={styles.meta}>Belegung, Mahlzeiten, Übergabe und Risikodokumentation</Text>
        </View>
