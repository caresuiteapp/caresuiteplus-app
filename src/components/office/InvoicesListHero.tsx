...
import type { InvoiceListKpi } from '@/data/demo/invoiceListStats';
import { ROLE_LABELS } from '@/data/demo';
import { isDemoMode } from '@/lib/supabase/config';
import type { RoleKey } from '@/types';
import { designTokens } from '@/theme';

type InvoicesListHeroProps = {
  kpis: InvoiceListKpi[];
  roleKey: RoleKey;
...
export function InvoicesListHero({
  kpis,
  roleKey,
  filteredCount,
  totalCount,
  ...
  return (
    <CareLightListHeroFrame accentColor={accent}>
      ...
      {canCreate ? (
        <CareLightButton title="➕ Rechnung anlegen" onPress={onCreatePress} accentColor={accent} />
      ) : null}
    </CareLightListHeroFrame>
  );
}
