...
import { OfficeMessageDetailSummaryPanel } from './OfficeMessageDetailSummaryPanel';
...
type OfficeMessageDetailModalProps = {
  visible: boolean;
...
export function OfficeMessageDetailModal({
  visible,
  messageId,
  onClose,
}: OfficeMessageDetailModalProps) {
    ...
    >
      <View style={styles.backdrop} accessibilityViewIsModal>
        ...
        <View style={styles.sheetHost} pointerEvents="box-none">
          ...
          >
            <GradientModalHeader title="Nachricht" onClose={onClose} />
            <ScrollView
              style={styles.scroll}
            ...
            >
              <OfficeMessageDetailSummaryPanel messageId={messageId} />
            </ScrollView>
          </GlassSurface>
        </View>
      </View>
