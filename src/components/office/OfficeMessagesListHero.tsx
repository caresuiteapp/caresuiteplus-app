...
import type { OfficeMessageListKpi } from '@/lib/office/officeMessageListStats';
import { ROLE_LABELS } from '@/data/constants';

import type { RoleKey } from '@/types';
import { designTokens } from '@/theme';

type OfficeMessagesListHeroProps = {
  kpis: OfficeMessageListKpi[];
  roleKey: RoleKey;
...
export function OfficeMessagesListHero({
  kpis,
  roleKey,
  filteredCount,
  totalCount,
