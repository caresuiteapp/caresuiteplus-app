...
import type { OfficeDocumentListKpi } from '@/data/demo/officeDocumentListStats';
...
export function DocumentsListHero({
  ...
  return (
    <CareLightListHeroFrame accentColor={accent}>
      ...
      {canUpload ? (
        <CareLightButton title="➕ Dokument hochladen" onPress={onUploadPress} accentColor={accent} />
      ) : null}
    </CareLightListHeroFrame>
  );
}
