...
type OfficeBroadcastDetailModalProps = {
  visible: boolean;
...
export function OfficeBroadcastDetailModal({
  visible,
  broadcastId,
  onClose,
  onArchived,
  onOpenThread,
}: OfficeBroadcastDetailModalProps) {
    ...
    >
      <View style={styles.backdrop} accessibilityViewIsModal>
        ...
        <View style={styles.sheetHost} pointerEvents="box-none">
          ...
          >
            <GradientModalHeader title="Broadcast" onClose={onClose} />
            <ScrollView
              style={styles.scroll}
