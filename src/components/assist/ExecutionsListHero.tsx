...
import type { ExecutionListKpi } from '@/data/demo/executionListStats';
import { ROLE_LABELS } from '@/data/demo';
import { isDemoMode } from '@/lib/supabase/config';
import type { RoleKey } from '@/types';
import { designTokens } from '@/theme';

type ExecutionsListHeroProps = {
  kpis: ExecutionListKpi[];
  roleKey: RoleKey;
...
export function ExecutionsListHero({
  kpis,
  roleKey,
  filteredCount,
  totalCount,
    ...
    <CareLightListHeroFrame accentColor={accent}>
      <View style={styles.topRow}>
        <View style={styles.textCol}>
          ...
          <Text style={styles.title}>Durchführung</Text>
