...
type AssistCalendarListHeroProps = {
...
export function AssistCalendarListHero({ groups, roleKey }: AssistCalendarListHeroProps) {
  ...
  const kpis = buildAssistCalendarKpis(groups, mode);

  return (
    <PremiumListHeroFrame>
      <View style={styles.topRow}>
        <View style={styles.textCol}>
          <Text style={styles.title}>Wochenübersicht</Text>
          <Text style={styles.meta}>Kalender und geplante Einsätze</Text>
        </View>
