...
export function AssignmentsListTable({
  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        primary: { color: "#F7FBFF", fontSize: font(16), lineHeight: font(24), fontWeight: "700" },
        meta: { color: "#B8CEE0", fontSize: font(15), lineHeight: font(23) },
        strongMeta: { color: "#CBE1F1", fontSize: font(14), lineHeight: font(22), fontWeight: "700" },
        cell: { gap: 5, minWidth: 0 },
        actions: {
          flexDirection: "row",
          flexWrap: "wrap",
          minWidth: 0,
