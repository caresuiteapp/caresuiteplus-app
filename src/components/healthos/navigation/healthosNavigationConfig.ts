    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: 'Aktueller Einsatz',
          icon: '▶️',
          visibility: 'hidden',
          planningNote: 'P0 Execute-Workflow — Deep-Link only, nicht Bottom-Nav.',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: '⏱️',
          visibility: 'hidden',
          planningNote: 'Route /portal/employee/arbeitszeit — P0 WFM, nicht ungeprüft in Nav.',
        },
        {
          key: 'absence',
