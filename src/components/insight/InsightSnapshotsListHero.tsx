...
type InsightSnapshotsListHeroProps = {
...
export function InsightSnapshotsListHero({
  items,
  roleKey,
  viewMode = 'cards',
  onViewModeChange,
  ...
  const kpis = buildInsightSnapshotListKpis(items, mode);
    ...
    <PremiumListHeroFrame>
      <View style={styles.topRow}>
        <View style={styles.textCol}>
          ...
          <Text style={styles.title}>Gespeicherte Snapshots</Text>
          <Text style={styles.meta}>Demo-KPI-Snapshots — kein Live-Warehouse</Text>
        </View>
