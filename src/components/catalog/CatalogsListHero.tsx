...
export function CatalogsListHero({
  items,
  roleKey,
  viewMode = 'cards',
  onViewModeChange,
  ...
  const kpis = buildCatalogListKpis(items, mode);

  return (
    <PremiumListHeroFrame>
      <View style={styles.topRow}>
        <View style={styles.textCol}>
          <Text style={styles.eyebrow}>OFFICE · KATALOGE</Text>
          <Text style={styles.title}>Leistungskataloge</Text>
          <Text style={styles.meta}>Leistungen, Tarife und Qualifikationen mandantenscharf</Text>
        </View>
