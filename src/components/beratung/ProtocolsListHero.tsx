...
import { buildProtocolListKpis } from '@/lib/beratung/beratungExtensionStats';
import {
...
export function ProtocolsListHero({
  items,
  roleKey,
  viewMode = 'cards',
  onViewModeChange,
  showViewToggle = false,
}: ProtocolsListHeroProps) {
  ...
  const kpis = buildProtocolListKpis(items, mode);

  return (
    <PremiumListHeroFrame>
      <View style={styles.topRow}>
        <View style={styles.textCol}>
          <Text style={styles.title}>Beratungsprotokolle</Text>
          <Text style={styles.meta}>Fallbezogene Dokumentation und Verlauf</Text>
        </View>
