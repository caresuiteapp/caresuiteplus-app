...
type CommunicationComposeHeroProps = {
  roleKey: RoleKey;
  isReadOnly?: boolean;
};

/** Premium compose header — aligned with Office Sprint 24 / CommunicationCenterListHero. */
export function CommunicationComposeHero({
  roleKey,
  isReadOnly = false,
