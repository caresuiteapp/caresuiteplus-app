...
const styles = StyleSheet.create({
  ...
  kicker: { color: '#6FF0B6', fontSize: font(13), lineHeight: font(18), fontWeight: '900', letterSpacing: 1 },
  title: { color: '#FFFFFF', fontSize: font(15), lineHeight: font(20), fontWeight: '900' },
  meta: { color: '#BBD3E4', fontSize: font(13), lineHeight: font(18), fontWeight: '600' },
  action: {
    minWidth: 82,
    minHeight: 44,
    borderRadius: 14,
  ...
  actionText: { color: '#FFFFFF', fontSize: font(13), lineHeight: font(18), fontWeight: '900' },
});
