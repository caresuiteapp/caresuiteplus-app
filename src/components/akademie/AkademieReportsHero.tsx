...
import { buildAkademieReportsKpis } from '@/lib/akademie/akademieExtensionStats';
import {
...
type AkademieReportsHeroProps = {
  stats: AkademieReportStats;
  roleKey: RoleKey;
};

export function AkademieReportsHero({ stats, roleKey }: AkademieReportsHeroProps) {
  ...
  const kpis = buildAkademieReportsKpis(stats, mode);
    ...
    <PremiumListHeroFrame>
      <View style={styles.topRow}>
        <View style={styles.textCol}>
          ...
          <Text style={styles.meta}>Kurse, Teilnahmen, Abschlüsse und Pflicht-Compliance</Text>
        </View>
