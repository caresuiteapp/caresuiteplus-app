...
import type { CourseListKpi } from '@/data/demo/courseListStats';
import { ROLE_LABELS } from '@/data/demo';
import { isDemoMode } from '@/lib/supabase/config';
import type { RoleKey } from '@/types';
import { designTokens } from '@/theme';

type CoursesListHeroProps = {
  kpis: CourseListKpi[];
  roleKey: RoleKey;
...
export function CoursesListHero({
  kpis,
  roleKey,
  filteredCount,
  totalCount,
...
}: CoursesListHeroProps) {
  const accent = moduleColor('akademie');
    ...
    <CareLightListHeroFrame accentColor={accent}>
      <View style={styles.topRow}>
        <View style={styles.textCol}>
          ...
          <Text style={styles.title}>Kurse</Text>
