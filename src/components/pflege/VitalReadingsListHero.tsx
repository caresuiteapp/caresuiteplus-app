...
import type { VitalListKpi } from '@/data/demo/vitalListStats';
...
type VitalReadingsListHeroProps = {
  kpis: VitalListKpi[];
  roleKey: RoleKey;
...
export function VitalReadingsListHero({
  kpis,
  roleKey,
  filteredCount,
  totalCount,
    ...
    <CareLightListHeroFrame accentColor={accent}>
      <View style={styles.topRow}>
        <View style={styles.textCol}>
          ...
          <Text style={styles.title}>Vitalwerte</Text>
