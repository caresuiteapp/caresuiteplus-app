/**
 * Assist Live-Status — central query using resolveLiveAssignment + persistence enrichment.
 */
...
import { resolveLiveVisitId } from './resolveLiveAssignment';
...
async function enrichTrackingFromPersistence(
  ...
  const visitId = await resolveLiveVisitId(tenantId, assignmentId);
