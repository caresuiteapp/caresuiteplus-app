...
export const AUTH_RLS_POLICIES: readonly AuthRlsPolicyEntry[] = [
  ...
  { name: 'employees_insert_tenant', table: 'employees', migration: '0076_employees_create_rls_live.sql', operation: 'INSERT', description: 'Mitarbeitende anlegen (has_permission)' },
  { name: 'employees_update_tenant', table: 'employees', migration: '0076_employees_create_rls_live.sql', operation: 'UPDATE', description: 'Mitarbeitende aktualisieren (has_permission)' },
