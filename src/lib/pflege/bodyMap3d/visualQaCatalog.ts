...
const diversityCases: BodyMapVisualQaCase[] = [
  ...
  },
  {
    ...
    label: adultDiversLabel,
    subtitle: 'Divers-Variante · Penis/Skrotum · Keine Brüste',
    selection: {
      sex: 'divers',
      ageGroup: 'erwachsener',
      genitalAnatomy: 'penis',
  ...
  },
  {
    ...
    label: adultDiversLabel,
    subtitle: 'Divers-Variante · Vulva · Brüste',
    selection: {
      sex: 'divers',
      ageGroup: 'erwachsener',
  ...
  },
  {
    ...
    label: adultDiversLabel,
    subtitle: 'Divers-Variante · Genitalanatomie unbekannt · Keine Brüste',
    selection: {
      sex: 'divers',
      ageGroup: 'erwachsener',
      genitalAnatomy: 'unbekannt',
