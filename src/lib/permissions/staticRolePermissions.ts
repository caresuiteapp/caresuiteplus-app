...
export const PERMISSION_LABELS: Record<PermissionKey, string> = {
  ...
  'pflege.vitals.manage': 'Vitalwerte konfigurieren und erfassen',
  'pflege.medications.view': 'Medikationsplan ansehen',
  'pflege.medications.manage': 'Medikationsplan verwalten',
  'pflege.medications.administer': 'Medikamentengaben dokumentieren',
  'pflege.wounds.view': 'Wunddokumentation ansehen',
  'pflege.wounds.manage': 'Wundfälle und Wundverläufe dokumentieren',
  'pflege.documentation.view': 'Pflegedokumentation ansehen',
  'pflege.documentation.create': 'Pflegeberichte und Beobachtungen erfassen',
  'pflege.documentation.sign': 'Pflegedokumentation fachlich signieren',
  'pflege.treatment.view': 'Behandlungspflege ansehen',
  'pflege.treatment.manage': 'Behandlungspflege durchführen und dokumentieren',
  'pflege.handovers.view': 'Übergaben ansehen',
  'pflege.handovers.manage': 'Übergaben erstellen und quittieren',
  'pflege.evaluations.view': 'Pflegeplan-Evaluationen ansehen',
  'pflege.evaluations.manage': 'Pflegeplan-Evaluationen dokumentieren',
...
const PFLEGE_VIEW: PermissionKey[] = [
  ...
  'pflege.wounds.view',
  'pflege.documentation.view',
  'pflege.treatment.view',
  'pflege.handovers.view',
...
const PFLEGE_MANAGE: PermissionKey[] = [
  ...
  'pflege.audit.view',
  'pflege.vitals.manage',
  'pflege.medications.manage',
  'pflege.medications.administer',
  'pflege.wounds.manage',
  'pflege.documentation.create',
  'pflege.documentation.sign',
  'pflege.treatment.manage',
