...
export const PERMISSION_LABELS: Record<PermissionKey, string> = {
  ...
  'office.documents.signatures.view': 'Signaturaufträge ansehen',
  'office.documents.signatures.manage': 'Signaturaufträge verwalten',
  ...
  'portal.employee.signatures.view': 'Unterschriftsdokumente ansehen',
  'portal.employee.signatures.sign': 'Dokumente unterschreiben',
