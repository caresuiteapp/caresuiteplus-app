...
export const PORTAL_FEATURE_MATRIX: PortalFeature[] = [
  { moduleKey: 'assist', featureKey: 'appointments', label: 'Einsätze', description: 'Assist-Einsätze und Besuche', navGroup: 'module', sortOrder: 10 },
  ...
  { moduleKey: 'assist', featureKey: 'nachweise', label: 'Nachweise', description: 'Leistungsnachweise und Belege', navGroup: 'module', sortOrder: 60, showInPrimaryNav: false },
  { moduleKey: 'assist', featureKey: 'aktivitaeten', label: 'Aktivitäten', description: 'Ihre Portal-Aktivitäten', navGroup: 'module', sortOrder: 62, showInPrimaryNav: false },
