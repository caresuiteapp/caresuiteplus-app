...
export const PORTAL_WIDGET_REGISTRY: PortalWidget[] = [
  ...
  { moduleKey: 'assist', widgetKey: 'assist_requests', title: 'Anfragen', description: 'Offene Portal-Anfragen', emptyState: 'Keine offenen Anfragen.', priority: 35, featureKey: 'anfragen', sortOrder: 40 },
  { moduleKey: 'assist', widgetKey: 'assist_activities', title: 'Aktivitäten', description: 'Letzte Portal-Aktivitäten', emptyState: 'Noch keine Aktivitäten.', priority: 30, featureKey: null, sortOrder: 45 },
  { moduleKey: 'assist', widgetKey: 'assist_signatures', title: 'Unterschriften', description: 'Ausstehende Unterschriften', emptyState: 'Keine Unterschriften ausstehend.', priority: 25, featureKey: 'documents', sortOrder: 50 },
