...
const TASK_TITLES: Record<ManagementTaskType, string> = {
  ...
  billing_blocker: 'Abrechnung blockiert',
  service_proof_review: 'Leistungsnachweis prüfen',
  review_service_record: 'Leistungsnachweis prüfen',
  review_exception: 'Ausnahme prüfen',
  client_cancel_request: 'Absageanfrage',
  client_reschedule_request: 'Verschiebungsanfrage',
  problem_report: 'Problemmeldung',
  emergency_follow_up: 'Notfall-Nachverfolgung',
  no_show_follow_up: 'Nicht erschienen — Nachverfolgung',
  ...
  audit_review: 'Audit prüfen',
  master_data_review: 'Stammdaten prüfen',
  absence_replacement: 'Abwesenheitsvertretung',
