...
export const MODULE_EXTENSION_LINKS: Partial<Record<ProductKey, ModuleExtensionLink[]>> = {
  ...
  pflege: [
    { path: '/pflege', label: 'Startseite', icon: '🏠' },
    { path: '/pflege/klienten', label: 'Klient:innen', icon: '👥' },
    { path: '/pflege/personal', label: 'Pflegepersonal', icon: '🧑‍⚕️' },
    { path: '/pflege/tourenplanung', label: 'Tourenplanung', icon: '🗺️' },
    ...
    { path: '/pflege/fuhrpark', label: 'Fuhrpark', icon: '🚗' },
    { path: '/pflege/inventar', label: 'Inventar', icon: '📦' },
