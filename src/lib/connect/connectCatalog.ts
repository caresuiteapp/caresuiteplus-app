...
export const CONNECT_CATALOG: ConnectCategory[] = [
  {
    ...
    integrations: [
      integration('gkv', 'GKV-Abrechnung', 'Gesetzliche Krankenversicherung — Abrechnungsdatenaustausch', 'coming_soon', false, '/business/connect/billing/prepare'),
      integration('sgb_xi', 'SGB XI', 'Pflegeversicherung nach SGB XI', 'coming_soon', false, '/business/connect/billing/prepare'),
      integration('sgb_v', 'SGB V', 'Krankenversicherung nach SGB V', 'coming_soon', false, '/business/connect/billing/prepare'),
      integration('pflegekassen', 'Pflegekassen', 'Abstimmung mit Pflegekassen und Kostenträgern', 'coming_soon', false, '/business/connect/billing/prepare'),
      integration('krankenkassen', 'Krankenkassen', 'Kostenträger-Kommunikation Krankenkassen', 'coming_soon', false, '/business/connect/billing/prepare'),
      integration('kostentraegerdateien', 'Kostenträgerdateien', 'Import und Prüfung von Kostenträger-Stammdaten', 'coming_soon', false, '/business/connect/billing/prepare'),
      integration('ik_pruefung', 'IK-Prüfung', 'Institutionskennzeichen-Validierung', 'coming_soon', false, '/business/connect/billing/prepare'),
      integration('abrechnungszentren', 'Abrechnungszentren', 'Anbindung an Abrechnungsdienstleister', 'coming_soon', true, '/business/connect/billing/prepare'),
    ],
  },
  {
    key: 'accounting',
  ...
  },
  {
    ...
    readiness: 'prepared',
    integrations: [
      integration('email', 'E-Mail', 'SendGrid, Mailjet, Brevo — transaktionale E-Mails (Prepare-Only)', 'prepared', true),
      integration('sms', 'SMS', 'Twilio, MessageBird — Erinnerungen und Benachrichtigungen (Prepare-Only)', 'prepared', true),
      integration('whatsapp', 'WhatsApp', 'WhatsApp Business API — Freigabe erforderlich, kein Versand', 'prepared', true),
      integration('push', 'Push', 'FCM, APNS — Push mit Geräte-Consent (Prepare-Only)', 'prepared', true),
      integration('telefonie', 'Telefonie', 'Anrufprotokoll und Telefonie-Vorbereitung (Prepare-Only)', 'prepared', true),
      integration('sip', 'SIP', 'SIP-Trunk und VoIP-Anbindung (Prepare-Only)', 'prepared', true),
    ],
  },
  {
    key: 'routes_gps',
  ...
  },
  {
    ...
    description: 'ICD-10-GM, SNOMED CT, LOINC/UCUM, ATC/DDD, PZN/IFA — Dokumentationshilfe',
    icon: '🩺',
    readiness: 'prepared',
    integrations: [
      integration('icd10_gm', 'ICD-10-GM', 'Diagnoseschlüssel — Kodierhilfe, ärztliche Angabe', 'prepared'),
      integration('snomed_ct', 'SNOMED CT', 'Klinische Terminologie — Lizenz erforderlich', 'coming_soon', true),
      integration('loinc', 'LOINC', 'Labor-/Vitalwert-Codes — Lizenz erforderlich', 'coming_soon', true),
      integration('ucum', 'UCUM', 'Einheiten-Codes — öffentliche Referenz', 'prepared'),
      integration('atc_ddd', 'ATC/DDD', 'WHO ATC/DDD — Lizenz erforderlich', 'coming_soon', true),
      integration('pzn_ifa', 'PZN/IFA', 'Pharmazentralnummer — Anbieter erforderlich', 'coming_soon', true),
      integration('rote_liste', 'Rote Liste', 'ABDATA — geschützte Datenbank, Lizenz erforderlich', 'disabled', true),
      integration('abdata', 'ABDATA', 'Arzneimitteldaten — ohne Lizenz deaktiviert', 'disabled', true),
      integration('bfarm_am', 'BfArM Arzneimitteldaten', 'Öffentliche Stammdaten — Medikationsübersicht', 'prepared'),
      integration('ops', 'OPS', 'Operationen- und Prozedurenschlüssel OPS', 'coming_soon'),
      integration('medikationsdb', 'Medikationsdatenbank', 'Stammdatenübersicht — keine Medikationsentscheidung', 'coming_soon'),
      integration('heilmittel', 'Heilmittel', 'Heilmittel-Stammdaten — reine Dokumentationshilfe', 'coming_soon'),
    ],
  },
  {
    key: 'hr_payroll',
  ...
  },
  {
    ...
    integrations: [
      ...
      integration('software_partner', 'Software-Partner', 'Software-Erweiterungen — Partner in Prüfung', 'coming_soon'),
