...
/** Align with LIVE_TRACKING_WINDOW_MINUTES_BEFORE — client sees map 30 min before start. */
export const CLIENT_PORTAL_VISIBILITY_BUFFER_MINUTES = LIVE_TRACKING_WINDOW_MINUTES_BEFORE;
