...
describe('System Liquid Glass V33', () => {
  it('besitzt genau drei verbindliche Markenfarben', () => {
    ...
    expect(Object.values(SYSTEM_LIQUID_COLORS)).toEqual(['#061126', '#1478FF', '#F8FBFF']);
  });
  ...
  it('stellt lesbare dunkle Glasschichten bereit', () => {
    expect(systemLiquidGlass.page).toBe(SYSTEM_LIQUID_COLORS.navy);
    expect(systemLiquidGlass.text.primary).toBe(SYSTEM_LIQUID_COLORS.white);
