...
export const liquidWorkAreas: Record<LiquidModuleKey, readonly LiquidWorkArea[]> = {
  ...
  pflege: [
    ...
    { id: 'treatment', label: 'Behandlungspflege', description: 'Verordnete Durchführung und Nachweis', pageType: 'work-list', route: '/pflege/behandlungspflege' },
    { id: 'handovers', label: 'Übergaben', description: 'Schichtübergabe, Quittierung und Risiken', pageType: 'review', route: '/pflege/uebergaben' },
    { id: 'risks', label: 'Risiken', description: 'Risikomatrix, Dringlichkeit und Review', pageType: 'review', route: '/pflege/risiken' },
    { id: 'evaluations', label: 'Evaluationen', description: 'Wirksamkeitsprüfung und Fortschreibung', pageType: 'review', route: '/pflege/evaluation' },
    { id: 'visits', label: 'Pflegevisiten', description: 'Fachliche Visiten und Feststellungen', pageType: 'review', route: '/pflege/visiten' },
    { id: 'deviations', label: 'Abweichungen', description: 'Qualitätsregelkreis und Wirksamkeitskontrolle', pageType: 'review', route: '/pflege/abweichungen' },
    { id: 'md-readiness', label: 'MD-Prüfbereitschaft', description: 'Sieben Live-Nachweise je Pflegefall', pageType: 'analytics', route: '/pflege/md-pruefbereitschaft' },
    { id: 'quality', label: 'Qualitätskennzahlen', description: 'Pflegequalität und Fälligkeiten', pageType: 'analytics', route: '/pflege/reports' },
    { id: 'proofs', label: 'Leistungsnachweise', description: 'Erfassen, signieren und prüfen', pageType: 'work-list', route: '/pflege/leistungsnachweise' },
    { id: 'billing', label: 'Abrechnung', description: 'Validierung, Sperren und Freigabe', pageType: 'review', route: '/pflege/abrechnung' },
    { id: 'invoice-foundations', label: 'Rechnungsgrundlagen', description: 'Freigegebene Leistungen bündeln', pageType: 'work-list', route: '/pflege/rechnungsgrundlagen' },
    { id: 'acceptance', label: 'Gesamtabnahme', description: 'Abrechnungsperiode verbindlich abnehmen', pageType: 'review', route: '/pflege/gesamtabnahme' },
    { id: 'settings', label: 'Einstellungen', description: 'Pflegekonfiguration und Modulsteuerung', pageType: 'settings', route: '/pflege/settings' },
  ],
  stationaer: [
