...
const recordRoutes: Partial<Record<LiquidModuleKey, Record<string, RouteBuilder>>> = {
  ...
  pflege: {
    clients: (id) => `/pflege/klienten?client=${id}`,
    staff: (id) => `/pflege/personal?employee=${id}`,
...
const primaryWorkflowRoutes: Partial<Record<LiquidModuleKey, Record<string, string>>> = {
  ...
  pflege: {
    home: '/pflege',
    clients: '/pflege/klienten?create=1',
    staff: '/pflege/personal?create=1',
    'tour-planning': '/pflege/tourenplanung',
    'duty-roster': '/pflege/dienstplaene/new',
    fleet: '/pflege/fuhrpark',
    inventory: '/pflege/inventar',
    sis: '/pflege/sis/new',
...
const primaryActionLabels: Partial<Record<LiquidModuleKey, Record<string, string>>> = {
  ...
  pflege: {
    home: 'Pflege-Startseite öffnen',
    clients: 'Klient:in anlegen',
    staff: 'Pflegepersonal anlegen',
    'tour-planning': 'Tourenplanung öffnen',
    'duty-roster': 'Schicht anlegen',
    fleet: 'Fuhrpark öffnen',
    inventory: 'Inventar öffnen',
    sis: 'SIS anlegen',
