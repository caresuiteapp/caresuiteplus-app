  ...
  return (
    <ImageBackground source={activeBackground.image} resizeMode="cover" style={styles.background} testID="responsive-desktop">
      ...
      <View style={[styles.workspace, compact && styles.workspaceCompact]}>
        <Animated.View style={[styles.glass, styles.sidebar, compact && styles.sidebarCompact, { pointerEvents: sidebarOpen ? "auto" : "none", width: sidebarMotion.interpolate({ inputRange: [0, 1], outputRange: [0, narrow ? 238 : 278] }), opacity: sidebarMotion, transform: [{ translateX: sidebarMotion.interpolate({ inputRange: [0, 1], outputRange: [-26, 0] }) }] }]}>
                ...
                <View key={widget?.id ?? `empty-${index}`} style={[styles.cell, { width: gridWidth ? gridLayout.cardWidth : '100%' }]}>
                  {widget ? (
                    <Pressable accessibilityRole="button" accessibilityLabel={`${widget.label} öffnen`} onPress={() => !editMode && openWidget(widget)} style={({ pressed }) => [styles.widgetCard, pressed && !editMode && styles.widgetPressed, editMode && styles.widgetEditing]}>
                      ...
                      <View style={styles.labelBar}><Text style={styles.widgetLabel}>{widget.label}</Text><Text style={styles.arrow}>↗</Text></View>
                    </Pressable>
                  ) : (
...
const styles = StyleSheet.create({
  ...
  desktopFrame: { flex: 1, minHeight: 0, width: "100%", maxWidth: 2560, alignSelf: "center", padding: 24, gap: 20 },
  topbar: { zIndex: 20, flexShrink: 0, flexWrap: "wrap", flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", gap: 20 },
  ...
  time: { color: "#FFF", fontSize: 31, lineHeight: 34, fontWeight: "900", letterSpacing: -1.2 }, date: { color: "#D8EAFF", fontSize: 13, fontWeight: "700" },
  ...
  actions: { flexWrap: "wrap", maxWidth: "100%", minHeight: 72, borderRadius: 24, padding: 9, flexDirection: "row", alignItems: "center", gap: 8 },
  ...
  profileTrigger: { minHeight: 52, flexDirection: "row", alignItems: "center", gap: 9, paddingHorizontal: 4 }, profileCopy: { maxWidth: 180, alignItems: "flex-end" }, profileName: { color: "#FFF", fontSize: 13, fontWeight: "900" }, profileRole: { color: "#BFD8EE", fontSize: 13, marginTop: 2, fontWeight: "700" },
  workspace: { flex: 1, minHeight: 0, minWidth: 0, zIndex: 5, flexDirection: "row", justifyContent: "center", gap: 16 }, workspaceCompact: { gap: 0 },
  ...
  sidebarCompact: { position: "absolute", left: 0, top: 0, bottom: 0, zIndex: 30, backgroundColor: "#091B32" },
  sidebar: { flexShrink: 0, height: "100%", borderRadius: 28, overflow: "hidden" }, sidebarInner: { minWidth: 220, height: "100%", padding: 15 }, sidebarHeader: { minHeight: 61, flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 5, paddingBottom: 12, borderBottomWidth: 1, borderBottomColor: "rgba(139,211,255,0.16)" },
  eyebrow: { color: "#72DEFF", fontSize: 11, lineHeight: 12, fontWeight: "900", letterSpacing: 1.6 }, sidebarTitle: { color: "#FFF", fontSize: 22, fontWeight: "900" }, closeSmall: { width: 34, height: 34, borderRadius: 12, borderWidth: 1, borderColor: "rgba(126,214,255,0.28)", alignItems: "center", justifyContent: "center" }, closeSmallText: { color: "#CDEFFF", fontSize: 25 },
  ...
  desktopPanel: { flex: 1, minHeight: 0, minWidth: 0, borderRadius: 30, paddingHorizontal: 17, paddingTop: 14, paddingBottom: 13, overflow: "hidden" }, topLine: { position: "absolute", top: 0, left: 54, right: 54, height: 1, backgroundColor: "rgba(204,244,255,0.62)" },
  desktopHeader: { flexShrink: 0, flexWrap: "wrap", minHeight: 90, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12, paddingHorizontal: 4, paddingBottom: 9 }, desktopHeading: { flex: 1, minWidth: 0 }, desktopTitle: { color: "#F7FCFF", fontSize: 35, lineHeight: 40, fontWeight: "900", letterSpacing: -0.6 }, desktopSubtitle: { color: "rgba(210,234,248,0.76)", fontSize: 13, fontWeight: "700" }, desktopActions: { flexWrap: "wrap", flexDirection: "row", gap: 7 }, countPill: { height: 34, borderRadius: 13, paddingHorizontal: 10, borderWidth: 1, borderColor: "rgba(105,207,242,0.22)", flexDirection: "row", alignItems: "center", gap: 6 }, countText: { color: "#CEE6F3", fontSize: 13, fontWeight: "900" }, editButton: { height: 34, borderRadius: 13, paddingHorizontal: 11, borderWidth: 1, borderColor: "rgba(126,214,255,0.28)", backgroundColor: "rgba(7,36,67,0.7)", justifyContent: "center" }, editButtonActive: { borderColor: "rgba(103,230,197,0.62)", backgroundColor: "rgba(24,107,91,0.68)" }, editText: { color: "#EAF8FF", fontSize: 13, fontWeight: "900" },
  gridScroll: { flex: 1, minHeight: 0 }, gridScrollContent: { paddingTop: 12, paddingBottom: 24 }, grid: { flexDirection: "row", flexWrap: "wrap", gap: 16, minWidth: 0 }, cell: { minWidth: 0 },
  ...
  imageStage: { height: 172, margin: 6, marginBottom: 3, borderRadius: 13, backgroundColor: "rgba(4,23,47,0.5)", alignItems: "center", justifyContent: "center", overflow: "hidden" }, widgetImage: { width: "100%", maxWidth: 280, height: "100%", opacity: 0.92 }, categoryPill: { position: "absolute", top: 7, left: 7, borderRadius: 9, paddingHorizontal: 7, paddingVertical: 4, backgroundColor: "rgba(1,14,31,0.78)" }, categoryText: { color: "#B9DCEB", fontSize: 11, fontWeight: "900", textTransform: "uppercase" }, removeButton: { position: "absolute", top: 7, right: 7, width: 27, height: 27, borderRadius: 14, borderWidth: 1, borderColor: "rgba(255,159,176,0.52)", backgroundColor: "rgba(91,15,33,0.9)", alignItems: "center", justifyContent: "center" }, removeText: { color: "#FFD4DC", fontSize: 20 },
  labelBar: { minHeight: 54, paddingVertical: 10, marginHorizontal: 6, marginBottom: 6, borderRadius: 11, paddingHorizontal: 10, borderWidth: 1, borderColor: "rgba(141,220,255,0.15)", backgroundColor: "rgba(1,12,28,0.8)", flexDirection: "row", alignItems: "center", gap: 5 }, widgetLabel: { flex: 1, color: "#F3FBFF", fontSize: 15, lineHeight: 22, fontWeight: "700" }, arrow: { color: "#77DFFF", fontSize: 13, fontWeight: "900" },
  emptyCard: { minHeight: 242, borderRadius: 18, borderWidth: 1, borderStyle: "dashed", borderColor: "rgba(126,208,244,0.25)", backgroundColor: "rgba(4,23,44,0.34)", alignItems: "center", justifyContent: "center" }, emptyHovered: { borderColor: "rgba(105,226,255,0.65)", backgroundColor: "rgba(8,54,78,0.5)" }, emptyPlus: { color: "#78E4FF", fontSize: 24 }, emptyTitle: { color: "#E9F8FF", fontSize: 13, fontWeight: "900" }, emptyCopy: { color: "#91B5CA", fontSize: 11, marginTop: 2 },
  backdrop: { flex: 1, backgroundColor: "rgba(0,5,16,0.8)", alignItems: "center", justifyContent: "center", padding: 18 }, centerPanel: { width: "100%", maxWidth: 1240, height: "86%", maxHeight: 830, borderRadius: 30, padding: 20, overflow: "hidden" }, centerHeader: { minHeight: 74, flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between", paddingBottom: 12 }, centerHeading: { flex: 1 }, centerTitle: { color: "#FFF", fontSize: 31, fontWeight: "900" }, centerSubtitle: { color: "#AFC9DC", fontSize: 13, marginTop: 3 }, closeButton: { width: 38, height: 38, borderRadius: 14, borderWidth: 1, borderColor: "rgba(145,211,245,0.2)", backgroundColor: "rgba(255,255,255,0.07)", alignItems: "center", justifyContent: "center" }, closeText: { color: "#FFF", fontSize: 27 },
  centerToolbar: { flexWrap: "wrap", gap: 10, minHeight: 49, flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderTopWidth: 1, borderBottomWidth: 1, borderColor: "rgba(128,205,242,0.13)", paddingVertical: 7 }, tabs: { flexDirection: "row", flexWrap: "wrap", gap: 5 }, tab: { height: 34, borderRadius: 12, paddingHorizontal: 15, justifyContent: "center" }, tabActive: { backgroundColor: "rgba(22,117,163,0.64)", borderWidth: 1, borderColor: "rgba(98,220,255,0.42)" }, tabText: { color: "#9DBACD", fontSize: 13, fontWeight: "900" }, tabTextActive: { color: "#FFF" }, search: { width: 280, height: 34, borderRadius: 12, borderWidth: 1, borderColor: "rgba(126,205,255,0.25)", backgroundColor: "rgba(1,11,28,0.7)", paddingHorizontal: 11, flexDirection: "row", alignItems: "center", gap: 7 }, searchGlyph: { color: "#80DFFF", fontSize: 17 }, searchInput: { flex: 1, height: "100%", color: "#FFF", fontSize: 13 },
  chips: { minHeight: 46, flexWrap: "wrap", flexDirection: "row", gap: 7, paddingVertical: 8 }, chip: { height: 30, borderRadius: 12, paddingHorizontal: 12, borderWidth: 1, borderColor: "rgba(126,205,255,0.16)", justifyContent: "center" }, chipActive: { borderColor: "rgba(104,224,255,0.48)", backgroundColor: "rgba(14,87,123,0.72)" }, chipText: { color: "#9FBDD0", fontSize: 13, fontWeight: "900" }, chipTextActive: { color: "#FFF" }, centerScroll: { flex: 1 }, centerContent: { paddingTop: 8, paddingBottom: 4 }, centerGrid: { flexDirection: "row", flexWrap: "wrap", marginHorizontal: -5 }, centerCell: { flexGrow: 1, flexBasis: 300, maxWidth: "100%", padding: 5 },
