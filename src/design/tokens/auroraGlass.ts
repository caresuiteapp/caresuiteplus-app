    ...
    () =>
      StyleSheet.create({
        ...
        dropdown: {
          ...
          borderRadius: careRadius.lg,
          borderWidth: 1,
          borderColor: active ? auroraGlass.borderStrong : colors.borderStrong,
          backgroundColor: active ? auroraGlass.elevated : colors.bgElevated,
          overflow: 'hidden',
        },
        optionList: {
          gap: 0,
        ...
        modalSheet: {
          backgroundColor: active ? auroraGlass.modal : colors.bgPremium,
