...
const styles = StyleSheet.create({
  ...
  focusHero: {
    ...
    padding: spacing.lg,
    gap: spacing.md,
    backgroundColor: 'rgba(5,20,50,0.82)',
    shadowColor: '#168BFF',
    shadowOpacity: 0.22,
    shadowRadius: 28,
  },
  ...
  focusTitle: { ...typography.h1, color: '#F7FBFF' },
  focusMeta: { ...typography.body, color: 'rgba(231,242,255,0.72)' },
  ...
  metric: { minWidth: 132, padding: spacing.sm, borderRadius: 16, backgroundColor: 'rgba(22,68,119,0.36)' },
  metricValue: { ...typography.h2, color: '#F7FBFF' },
  metricLabel: { ...typography.caption, color: 'rgba(231,242,255,0.68)' },
  ...
  sectionRail: {
    ...
    borderRadius: 22,
    backgroundColor: 'rgba(4,16,40,0.76)',
    padding: spacing.sm,
  },
  ...
  navNumber: { ...typography.caption, color: 'rgba(231,242,255,0.58)', fontVariant: ['tabular-nums'] },
  navNumberActive: { color: colors.cyan },
  navLabel: { ...typography.label, color: 'rgba(231,242,255,0.68)', flexShrink: 1 },
  navLabelActive: { color: '#F7FBFF' },
  ...
  legalNoteText: { ...typography.caption, color: 'rgba(231,242,255,0.68)', marginTop: 4 },
  documentCanvas: {
    flex: 1,
    minWidth: 0,
    borderWidth: 1,
    ...
    padding: spacing.md,
    gap: spacing.md,
    backgroundColor: 'rgba(5,17,42,0.72)',
  },
