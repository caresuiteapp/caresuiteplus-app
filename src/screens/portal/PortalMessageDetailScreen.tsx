...
export function PortalMessageDetailScreen() {
  ...
  const canView = can('portal.employee.messages.view');
  const canReply = can('portal.employee.messages.reply');
  ...
  return (
    ...
    >
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <PortalMessageDetailHero message={data} scope="employee" />
        ...
        {data.canReply && canReply ? (
          <View style={styles.replyBox}>
            <PremiumInput
              ...
              placeholder="Ihre Nachricht an die Einsatzplanung…"
              multiline
            />
          ...
          <LockedActionBanner
            message={check('portal.employee.messages.reply').reason ?? 'Keine Berechtigung.'}
            roleLabel={roleLabel}
          />
        ) : null}
      </ScrollView>
