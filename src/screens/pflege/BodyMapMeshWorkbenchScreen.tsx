...
const styles = StyleSheet.create({
  page: { flex: 1, backgroundColor: '#F8FBFF' },
  ...
  title: { color: '#0B1220', fontSize: 28, fontWeight: '900', marginTop: 5 },
  ...
  statusBadgeText: { color: '#0B1220', fontSize: 12, fontWeight: '900' },
  workspace: { flexDirection: 'row', alignItems: 'flex-start', gap: 18 },
  sidebar: { width: 330, gap: 14 },
  main: { flex: 1, minWidth: 0 },
  panelTitle: { color: '#0B1220', fontSize: 14, fontWeight: '900' },
  panelHint: { color: '#64748B', fontSize: 12, lineHeight: 18 },
  variantList: {
    borderWidth: 1,
  ...
  variantLinkActive: { color: '#0B1220', backgroundColor: 'rgba(23,105,224,0.12)' },
  contractPanel: {
    borderWidth: 1,
    borderColor: 'rgba(112,165,255,0.2)',
    borderRadius: 16,
  ...
  checkText: { flex: 1 },
  checkLabel: { color: '#0B1220', fontSize: 12, fontWeight: '800' },
  checkDetail: { color: '#64748B', fontSize: 10, lineHeight: 15, marginTop: 2 },
  notice: {
    borderWidth: 1,
  ...
  noticeTitle: { color: '#0B1220', fontSize: 13, fontWeight: '900' },
  noticeText: { color: '#475569', fontSize: 11, marginTop: 4 },
